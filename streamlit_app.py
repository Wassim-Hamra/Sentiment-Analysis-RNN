...
if prediction_proba > 0.5:
    st.markdown('<div class="box"><h2>Client is likely to churn 😢</h2></div>', unsafe_allow_html=True)
else:
    st.markdown('<div class="box"><h2>Client is not likely to churn 😌</h2></div>', unsafe_allow_html=True)
